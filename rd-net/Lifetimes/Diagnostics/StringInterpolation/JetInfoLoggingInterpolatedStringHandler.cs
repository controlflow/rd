...
public ref struct JetInfoLoggingInterpolatedStringHandler
{
  private JetLoggingInterpolatedStringHandler myHandler;

  public bool IsEnabled => myHandler.IsEnabled;

  public JetInfoLoggingInterpolatedStringHandler(
    int literalLength,
    int formattedCount,
    ILog logger,
    out bool isEnabled)
  {
    myHandler = new JetLoggingInterpolatedStringHandler(literalLength, formattedCount, logger, LoggingLevel.INFO, out isEnabled);
  }
