...
public ref struct JetErrorLoggingInterpolatedStringHandler
{
  private JetLoggingInterpolatedStringHandler myHandler;

  public bool IsEnabled => myHandler.IsEnabled;

  public JetErrorLoggingInterpolatedStringHandler(
    int literalLength,
    int formattedCount,
    ILog logger,
    out bool isEnabled)
  {
    myHandler = new JetLoggingInterpolatedStringHandler(literalLength, formattedCount, logger, LoggingLevel.ERROR, out isEnabled);
  }
