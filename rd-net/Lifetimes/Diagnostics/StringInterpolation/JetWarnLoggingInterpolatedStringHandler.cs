...
public ref struct JetWarnLoggingInterpolatedStringHandler
{
  private JetLoggingInterpolatedStringHandler myHandler;

  public bool IsEnabled => myHandler.IsEnabled;

  public JetWarnLoggingInterpolatedStringHandler(
    int literalLength,
    int formattedCount,
    ILog logger,
    out bool isEnabled)
  {
    myHandler = new JetLoggingInterpolatedStringHandler(literalLength, formattedCount, logger, LoggingLevel.WARN, out isEnabled);
  }
