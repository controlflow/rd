...
public ref struct JetTraceLoggingInterpolatedStringHandler
{
  private JetLoggingInterpolatedStringHandler myHandler;

  public bool IsEnabled => myHandler.IsEnabled;

  public JetTraceLoggingInterpolatedStringHandler(
    int literalLength,
    int formattedCount,
    ILog logger,
    out bool isEnabled)
  {
    myHandler = new JetLoggingInterpolatedStringHandler(literalLength, formattedCount, logger, LoggingLevel.TRACE, out isEnabled);
  }
